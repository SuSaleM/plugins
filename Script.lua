...
if not redis:get(js..'group:add'..msg.chat_id_) then return sendMsg(msg.chat_id_,msg.id_,'*៛ المجموعه بالتأكيد تم تعطيلها* \n \n') end  
...
KleshaID = KleshaID:gsub("#bot",redis:get(js..':NameBot:'))
...
message = message..' ['..info.username..'](t.me/jjjse)  \n'
...
if not msg.Admin then return "لا يُمكنك تنفيذ هذا الأمر أعتذر.  \n" end
...
return sendMsg(arg.ChatID,arg.MsgID,"៛  لا يمكنك تقييد مُـحمد سـَالِم\n")
elseif UserID == 1399227146 then
return sendMsg(arg.ChatID,arg.MsgID,"៛  لا يمكنك تقييد مُـحمد آل صَـافِي\n")
...
elseif UserID == 1399282735 then 
return sendMsg(msg.chat_id_,msg.id_,"៛  لا يمكنك تقييد مُـحمد سـَالِم\n") 
elseif UserID == 1399227146 then 
return sendMsg(msg.chat_id_,msg.id_,"៛  لا يمكنك تقييد مُـحمد آل صَـافِي\n")     
...
elseif UserID == 1399282735 then 
return sendMsg(arg.ChatID,arg.MsgID,"៛  لا يمكنك طرد مُـحمد سـَالِم\n") 
elseif UserID == 1399227146 then 
return sendMsg(arg.ChatID,arg.MsgID,"៛  لا يمكنك طرد مُـحمد آل صَـافِي\n")     
elseif UserID == SUDO_ID then 
...
elseif UserID == 1399282735 then 
return sendMsg(arg.ChatID,arg.MsgID,"៛  لا يمكنك حظر مُـحمد سـَالِم\n") 
elseif UserID == 1399227146 then 
return sendMsg(arg.ChatID,arg.MsgID,"៛  لا يمكنك حظر مُـحمد آل صَـافِي\n") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1399282735 then 
return sendMsg(arg.ChatID,arg.MsgID,"៛  لا يمكنك كتم مُـحمد سـَالِم\n") 
elseif UserID == 1399227146 then 
return sendMsg(arg.ChatID,arg.MsgID,"៛  لا يمكنك كتم مُـحمد آل صَـافِي\n")     
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
...
if not redis:get(js.."lock_linkk"..msg.chat_id_) then return "៛  الامر معطل من قبل الادارة \n^"  end
...
if not msg.Director then return "៛  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(js..'linkGroup'..msg.chat_id_) then 
...
if not redis:get(js.."lock_takkl"..msg.chat_id_) then  return "الامر معطل من قبل الادراة يبشه." end 
...
return '៛   عدد جهاتك يبشه‏‏ ⇜ 【'..(redis:get(js..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..'】 . \n'
end
...
if UserID == 1399282735 then return sendMsg(msg.chat_id_,msg.id_,"៛  لآ يمكنك تنفيذ الامر ضد مُـحمد سـَالِم \n") end
if UserID == 1399227146 then return sendMsg(msg.chat_id_,msg.id_,"៛  لآ يمكنك تنفيذ الامر ضد مُـحمد آل صَـافِي \n") end
...
redis:setex(js..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[*مرحبـاً أنا جيسي 🍬*
...
return'៛  شـرط آلتفعيل آلبوت آذآ كآنت آلمـجمـوعهہ‏‏ آكثر مـن *【'..redis:get(js..':addnumberusers')..'】* عضـو  ៛ \n' 
end 
end
...
if not msg.SudoUser then return "៛  هذا الامر يخص {المطور} فقط  \n" end
return '៛ عدد المجموعات المفعلة ⇜ `'..redis:scard(js..'group:ids')..'`  ➼' 
end
...
return redis:get(js..":TEXT_SUDO") or '🗃¦ لا توجد كليشه المطور .\n📰¦ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end
...
return '*៛ اصدار سورس جيسي ❪* `v'..version..'` *❫* \n'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "*هذا الامر يخص {المطور الاساسي} فقط*\n" end
local GetVerison = https.request('https://raw.githubusercontent.com/SuSaleM/plugins/main/ver.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'៛  عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس جيسي يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="Source Channel : 𝙅𝙀𝙎𝙎𝙀",url="t.me/jjjse"}}}
send_key(msg.sender_user_id_,'  [Source : 𝙅𝙀𝙎𝙎𝙀 ](t.me/jjjse)',nil,inline,msg.id_)
return false
end
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م4" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="اوامر الرد" or MsgText[1]=="الاوامر") and redis:get(js..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(js..":awamer_Klesha_m4:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
if MsgText[1]== "جيسيي" or MsgText[1]=="جيسي" then
local inline = {{{text="𝙎𝙊𝙐𝙍𝘾𝙀",url="t.me/jjjse"}}}
send_key(msg.sender_user_id_,'𝙅𝙀𝙎𝙎𝙀',nil,inline,msg.id_)
end
...
return " اوبس , هناك خطأ في مصفوفه الجيسون راسل مُـحمد سـَالِم ليتمكن من حل المشكله في اسرع وقت ممكن.!"
end
else
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/SuSaleM/plugins/main/"..FileName)
if res == 200 then
...
if msg.SudoBase then
local text = '៛ منور يـَعم شوف اوامِر الكيبورد وسيطر'
...
if msg.content_.caption_ then redis:hset(js..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then
...
if msg.text=="م1" or msg.text=="م2" or msg.text=="م3" or msg.text=="م4" or msg.text=="م المطور" or msg.text=="اوامر الرد" or msg.text=="الاوامر" then return false end
...
elseif amr == "م4" then
redis:set(js..":awamer_Klesha_m4:",msg.text)
...
if msg.content_.ID == "MessagePhoto" and redis:get(js..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(js..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
redis:set(js..":Added:Me:Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
...
welcome = welcome:gsub("{القوانين}", redis:get(js..'rulse:msg'..msg.chat_id_) or "៛ مرحبأ عزيري ៛  القوانين كلاتي ៛ \n✶ ممنوع نشر الروابط \n✶ ممنوع التكلم او نشر صور اباحيه \n✶ ممنوع  اعاده توجيه \n✶ ممنوع التكلم بلطائفه \n✶ الرجاء احترام المدراء والادمنيه \n")
...
local welcome = welcome:gsub("#bot",redis:get(js..':NameBot:'))
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(js..'welcome:msg'..msg.chat_id_) or "៛ مرحباً عزيزي\n✶ نورت المجموعة \n")
welcome = welcome:gsub("{القوانين}", redis:get(js..'rulse:msg'..msg.chat_id_) or "៛ مرحبأ عزيري ៛  القوانين  ៛ \n✶ ممنوع نشر الروابط \n✶ ممنوع التكلم او نشر صور اباحيه \n✶ ممنوع  اعاده توجيه \n✶ ممنوع التكلم بلطائفه \n✶ الرجاء احترام المدراء والادمنيه 😅\n")
...
return false
elseif (msg.text:match("ه‍") or msg.text:match("ی") or msg.text:match("ک")) and redis:get(js.."lock_pharsi"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif KlmatMmno3(msg.text) and redis:get(js.."lock_mmno3"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[مُـحمد سـَالِم](https://t.me/r00t94)")
