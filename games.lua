name = string.gsub(name,' *سال9م ','* كلمة لشخص أسعدك رغم حزنك في يومٍ من الأيام ؟ ')
name = string.gsub(name,' *سال10م ','* شيء عندك اهم من الناس ؟ ')
name = string.gsub(name,' *سال11م ','* اول ولد لك وش راح تسميه ؟ ')
name = string.gsub(name,' *سال12م ','* تفضّل النقاش الطويل او تحب الاختصار ؟ ')
name = string.gsub(name,' *سال13م ','* وش أخر شي ضيعته؟ ')
name = string.gsub(name,' *سال14م ','* عادي تتزوج من برا القبيلة؟ ')
name = string.gsub(name,' *سال15م ','* كم مره حبيت؟ ')
name = string.gsub(name,' *سال16م ','*تبادل الكراهية بالكراهية؟ ولا تحرجه بالطيب؟')
name = string.gsub(name,' *سال17م ','*لو فزعت/ي لصديق/ه وقالك مالك دخل وش بتسوي/ين؟')
name = string.gsub(name,' *سال18م ','*قلبي على قلبك مهما صار لمين تقولها؟')
name = string.gsub(name,' *سال19م ','*اكثر المتابعين عندك باي برنامج؟')
name = string.gsub(name,' *سال20م ','*نسبة النعاس عندك حاليًا؟')
name = string.gsub(name,' *سال21م ','*نسبه الندم عندك للي وثقت فيهم ؟')
name = string.gsub(name,' *سال22م ','*وش اسم اول شخص تعرفت عليه فالتلقرام ؟')
name = string.gsub(name,' *سال23م ','*جربت شعور احد يحبك بس انت مو قادر تحبه؟')
name = string.gsub(name,' *سال24م ','*تجامل الناس ولا اللي بقلبك على لسانك؟')
name = string.gsub(name,' *سال25م ','*عمرك ضحيت باشياء لاجل شخص م يسوى ؟')
name = string.gsub(name,' *سال26م ','* مغني تلاحظ أن صوته يعجب الجميع إلا أنت؟ ')
name = string.gsub(name,' *سال27م ','*آخر غلطات عمرك؟ ')
name = string.gsub(name,' *سال28م ','*مسلسل كرتوني له ذكريات جميلة عندك؟ ')
name = string.gsub(name,' *سال29م ','*ما أكثر تطبيق تقضي وقتك عليه؟ ')
name = string.gsub(name,' *سال30م ','*أول شيء يخطر في بالك إذا سمعت كلمة نجوم ؟ ')
name = string.gsub(name,' *سال31م ','*قدوتك من الأجيال السابقة؟ ')
name = string.gsub(name,' *سال32م ','*أكثر طبع تهتم بأن يتواجد في شريك/ة حياتك؟ ')
name = string.gsub(name,' *سال33م ','* أكثر حيوان تخاف منه؟ ')
name = string.gsub(name,' *سال34م ','*ما هي طريقتك في الحصول على الراحة النفسية؟ ')
name = string.gsub(name,' *سال35م ','*إيموجي يعبّر عن مزاجك الحالي؟ ')
name = string.gsub(name,' *سال36م ','*أكثر تغيير ترغب أن تغيّره في نفسك؟ ')
name = string.gsub(name,' *سال37م ','* أكثر شيء أسعدك اليوم؟ ')
name = string.gsub(name,' *سال38م ','* بماذا يتعافى المرء؟ ')
name = string.gsub(name,' *سال39م ','* ما هو أفضل حافز للشخص؟ ')
name = string.gsub(name,' *سال40م ','* ما الذي يشغل بالك في الفترة الحالية؟')
name = string.gsub(name,' *سال41م ','* آخر شيء ندمت عليه؟ ')
name = string.gsub(name,' *سال42م ','* شاركنا صورة احترافية من تصويرك؟ ')
name = string.gsub(name,' *سال43م ','* تتابع انمي؟ إذا نعم ما أفضل انمي شاهدته ')
name = string.gsub(name,' *سال44م ','* يرد عليك متأخر على رسالة مهمة وبكل برود، موقفك؟ ')
name = string.gsub(name,' *سال45م ','* نصيحه تبدا ب -لا- ؟ ')
name = string.gsub(name,' *سال46م ','* كتاب أو رواية تقرأها هذه الأيام؟ ')
name = string.gsub(name,' *سال47م ','* فيلم عالق في ذهنك لا تنساه مِن روعته؟ ')
name = string.gsub(name,' *سال48م ','* يوم لا يمكنك نسيانه؟ ')
name = string.gsub(name,' *سال49م ','* شعورك الحالي في جملة؟ ')
name = string.gsub(name,' *سال50م ','* أكثر سبب منطقي يمكن أن يجعلك تقرر الإبتعاد عن الشخص الذي تُحب؟ ')
name = string.gsub(name,' *سال51م ','* كلمة لشخص بعيد؟ ')
name = string.gsub(name,' *سال52م ','* صفة يطلقها عليك الشخص المفضّل؟ ')
name = string.gsub(name,' *سال53م ','* أغنية عالقة في ذهنك هاليومين؟ ')
name = string.gsub(name,' *سال54م ','* أكلة مستحيل أن تأكلها؟ ')
name = string.gsub(name,' *سال55م ','* كيف قضيت نهارك؟ ')
name = string.gsub(name,' *سال56م ','* تصرُّف ماتتحمله؟ ')
name = string.gsub(name,' *سال57م ','* صفة يطلقها عليك من حولك بكثرة؟ ')
name = string.gsub(name,' *سال58م ','* اسوء صفه فيك وتجاهد على تغييرها؟ ')
name = string.gsub(name,' *سال59م ','* شاركنا أقوى بيت شِعر من تأليفك؟ ')
name = string.gsub(name,' *سال60م ','* ماذا لو عاد معتذراً؟ ')
name = string.gsub(name,' *سال61م ','* تقطع علاقتك بالشخص إذا عرفت إنه...؟ ')
name = string.gsub(name,' *سال62م ','* كلام ودك يوصل للشخص المطلوب ؟ ')
name = string.gsub(name,' *سال63م ','* ردة فعلك لمن يتجاهلك بالرد متعمد؟ ')
name = string.gsub(name,' *سال64م ','* كم نسبة البيتوتية في شخصيتك؟ ')
name = string.gsub(name,' *سال65م ','* متى تحس أنك فعلًا أنسان صبور جدًا ؟ ')
name = string.gsub(name,' *سال66م ','* هل أنت من النوع الذي يواجه المشاكل أو من النوع الذي يهرب ؟ ')
name = string.gsub(name,' *سال67م ','* أمنية كنت تتمناها وحققتها ؟ ')
name = string.gsub(name,' *سال68م ','* تملك وسواس من شيء معين ؟ ')
name = string.gsub(name,' *سال69م ','* عمرك انتقمت من أحد ؟! ')
name = string.gsub(name,' *سال70م ','* متى تقرر تنسحب من أي علاقة ؟ ')
name = string.gsub(name,' *سال71م ','* كلمتين تكررها دايم ؟! ')
name = string.gsub(name,' *سال72م ','* افضل هديه ممكن تناسبك؟ ')
name = string.gsub(name,' *سال73م ','* انت حزين اول شخص تتصل عليه؟ ')
name = string.gsub(name,' *سال74م ','* موقف خلاك تحس انك مكسور ؟ ')
name = string.gsub(name,' *سال75م ','* ماذا لو كانت مشاعر البشر مرئية ؟ ')
name = string.gsub(name,' *سال76م ','* كم تشوف انك تستحق فرصه؟ ')
name = string.gsub(name,' *سال77م ','* يهمك ظن الناس فيك ولا ؟ ')
name = string.gsub(name,' *سال78م ','* اغنية عندك معاها ذكريات ')
name = string.gsub(name,' *سال79م ','* موقف غير حياتك؟ ')
name = string.gsub(name,' *سال80م ','* اكثر مشروب تحبه؟ ')
name = string.gsub(name,' *سال81م ','* القصيدة اللي تأثر فيك؟ ')
name = string.gsub(name,' *سال82م ','* متى يصبح الصديق غريب ')
name = string.gsub(name,' *سال83م ','* هل وصلك رسالة غير متوقعة من شخص وأثرت فيك ؟ ')
name = string.gsub(name,' *سال84م ','* وين نلقى السعاده برايك؟ ')
name = string.gsub(name,' *سال85م ','* تاريخ ميلادك؟ ')
name = string.gsub(name,' *سال86م ','* قهوه و لا شاي؟ ')
name = string.gsub(name,' *سال87م ','* من محبّين الليل أو الصبح؟ ')
name = string.gsub(name,' *سال88م ','* حيوانك المفضل؟ ')
name = string.gsub(name,' *سال89م ','* كلمة غريبة ومعناها؟ ')
name = string.gsub(name,' *سال90م ','* هل التعود على شخص والتحدث معه بشكل يومي يعتبر نوع من أنواع الحب؟ ')
name = string.gsub(name,' *سال91م ','* كم تحتاج من وقت لتثق بشخص؟ ')
name = string.gsub(name,' *سال92م ','* اشياء نفسك تجربها؟ ')
name = string.gsub(name,' *سال93م ','* يومك ضاع على؟ ')
name = string.gsub(name,' *سال94م ','* كل شيء يهون الا ؟ ')
name = string.gsub(name,' *سال95م ','* اسم ماتحبه ؟ ')
name = string.gsub(name,' *سال96م ','* وقفة إحترام للي إخترع ؟ ')
name = string.gsub(name,' *سال97م ','* أقدم شيء محتفظ فيه من صغرك؟ ')
name = string.gsub(name,' *سال98م ','* كلمات ماتستغني عنها بسوالفك؟ ')
name = string.gsub(name,' *سال99م ','* وش الحب بنظرك؟ ')
name = string.gsub(name,' *سال100م ','* حب التملك في شخصِيـتك ولا ؟ ')
name = string.gsub(name,' *سال101م ','* تخطط للمستقبل ولا ؟ ')
name = string.gsub(name,' *سال102م ','* موقف محرج ماتنساه ؟ ')
name = string.gsub(name,' *سال103م ','* من طلاسم لهجتكم ؟ ')
name = string.gsub(name,' *سال104م ','* اعترف باي حاجه ؟ ')
name = string.gsub(name,' *سال105م ','* عبّر عن مودك بصوره ؟ ')
name = string.gsub(name,' *سال106م ','* اسم دايم ع بالك ؟ ')
name = string.gsub(name,' *سال107م ','* اشياء تفتخر انك م سويتها ؟ ')
name = string.gsub(name,' *سال108م ','*  لو بكيفي كان ؟ ')
name = string.gsub(name,' *سال109م ','* تحب تحتفظ بالذكريات ؟ ')
name = string.gsub(name,' *سال110م ','* اغلب وقتك ضايع في؟ ')
name = string.gsub(name,' *سال111م ','* اكثر كلمة تنقال لك بالبيت ؟ ')
name = string.gsub(name,' *سال112م ','* كلمتك التسليكيه ؟ ')
name = string.gsub(name,' *سال113م ','* تزعلك الدنيا ويرضيك ؟ ')
name = string.gsub(name,' *سال114م ','* عندك فوبيا او خوف شديد من شيء معين ؟ ')
name = string.gsub(name,' *سال115م ','*  غزل بلهجتك ؟ ')
name = string.gsub(name,' *سال116م ','* ردة فعلك لما تنظلم من شخص ؟ ')
name = string.gsub(name,' *سال117م ','* شيء تعترف انك فاشل فيه ؟ ')
name = string.gsub(name,' *سال118م ','* اكثر كلمة ترفع ضغطك ؟ ')
name = string.gsub(name,' *سال119م ','* نسبة جمال صوتك ؟ ')
name = string.gsub(name,' *سال120م ','* كيف تتعامل مع الشخص المُتطفل ( الفضولي ) ؟ ')
name = string.gsub(name,' *سال121م ','* من الاشياء اللي تجيب لك الصداع ؟ ')
name = string.gsub(name,' *سال122م ','* حصلت الشخص اللي يفهمك ولا باقي ؟ ')
return '-› '..name..'  ' 
end
...
return [[ 
*✶  الالعاب لبوت* *❪* ]]..redis:get(js..':NameBot:')..[[ *❫*  *، ! 🎖*
